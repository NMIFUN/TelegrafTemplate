        ...
        if (ctx.state[1]) {
            ...
            result.status =
                Object.keys(statuses)[
                    pureIndex >= 0 ? pureIndex : length + pureIndex
                ]
            await result.save()
        }
        ...
        if (result.status === "notStarted")
            extraKeyboard = extraKeyboard.concat([
                [
                    ...
                    Markup.callbackButton(
                        `🧹`,
                        `admin_view_keyboard_${result._id}_del`
                    ),
                ],
                [
                    Markup.callbackButton(
                    ...
                    Markup.callbackButton(
                        `🧹`,
                        `admin_view_startDate_${result._id}_del`
                    ),
                ],
                [
                    Markup.callbackButton(
                    ...
                    Markup.callbackButton(
                        `🧹`,
                        `admin_view_endDate_${result._id}_del`
                    ),
                ],
                [
                    Markup.callbackButton(
                    ...
                    Markup.callbackButton(
                        `🧹`,
                        `admin_view_quantity_${result._id}_del`
                    ),
                ],
                [
                    Markup.callbackButton(
                    ...
                    Markup.callbackButton(
                        `🧹`,
                        `admin_view_lang_${result._id}_del`
                    ),
                ],
                [
                    Markup.callbackButton(
